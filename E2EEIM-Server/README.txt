...
4. Open your terminal command prompt and change your current directory to
   E2EEIM/E2EEIM-Desktop, the Qt project folder that contains the
   E2EEIM-Server.pro file.
5. Set gpgme.h INCLUDEPATH and libgpgme LIBS path in E2EEIM-Server.pro file in
...
HOW TO RUN
1. Configure your firewall to open the port for E2EEIM-Server.
   It is customary to use port 2222 for this.
2. Configure GUI pinentry for gpg-agent
    For macOS(GPGTools Pinentry mac)
    For Linux(pinentry-gtk2)
3. Configure gpg-agent to remember passphrases for as long as passible.
4. Find the name of the executable file.
5. Execute that excecutable file.
