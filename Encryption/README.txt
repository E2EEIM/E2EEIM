...
NOTE: 
1. The program require main.cpp at runtime, main.cpp and execute file need to be in the same directory.
2. The program use user keyring.
3. At runtime, the program generated 5 files as follow
E2EEIM_Public_Key.key
main.cpp.SymEncrypted
main.cpp.SymDncrypted
main.cpp.AsymEncrypted
main.cpp.AsymDncrypted
...
Encrypt  main.cpp and placing the result into  main.cpp.SymEncrypted

Finished encryption, output saved into main.cpp.SymEncrypted

8-------- Symmetric Decryption-----------8
Finished decryption, output saved into main.cpp.SymDecrypted

9--------Asymmetric Encryption-----------9
Finished encryption, output saved into main.cpp.AsymEncrypted

10--------Asymmetric Decryption----------10
Finished decryption, output saved into main.cpp.AsymDecrypted
