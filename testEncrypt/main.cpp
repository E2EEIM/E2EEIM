// Example GPGME program from
// https://stackoverflow.com/questions/9817536
...
void gpgEncrypt(const char *fileToEncrypt, const char *outputFileName,
                char *encryptTo[],
                unsigned long encryptToLength) {

    printf("%s", fileToEncrypt);
    gpgme_ctx_t ctx;
    gpgme_error_t err;
    gpgme_data_t in, out;
