...
On macOS
  ...
  3. run <b>qmake</b> command. <b>qmake</b> will generate Makefile (You need to set PATH to <b>qmake</b> from <b>[QT_INSTALLED_DIRECTORY]/[COMPILER]/qmake</b>). If <b>qmake</b> show any occur error, please check your <b>Qt</b> version first (qmake --version).
